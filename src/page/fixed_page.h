...
public:
    ...
    PAGE_FIELD_REF(field_size, uint16_t, 2);
    PAGE_FIELD_REF(size,       int32_t,  4);
    PAGE_FIELD_REF(next_page,  int32_t,  8);
    PAGE_FIELD_REF(prev_page,  int32_t,  12);
    
    PAGE_FIELD_PTR(children,   int32_t,  16);
